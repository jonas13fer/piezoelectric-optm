%----------------------------------------------------------------%
%First author: Romes A. Borges
%Edited by: Jonas F. Oliveira
%Rectangular plates
%----------------------------------------------------------------%
%function[f,g]=let_a(x)  %function defined for piezo-plate optimization
function[f]=let_a(x)  %function defined for piezo-plate optimization
%
...
f_aux=(-Wabs(2,1)+2.134e-5); %função auxiliar
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%f=-wwdmax;
...
f=f_aux
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%constraints for the minimal patch dimensions allowed
%g1=x(1)-x(2)+0.04;         %constraint: x2-x1>0.04
%g2=x(3)-x(4)+0.02;         %constraint: y2-y1>0.02
%constraints for the maximal patch dimensions allowed
%g3=x(2)-x(1)-0.15;         %constraint: x2-x1<0.15
%g4=x(4)-x(3)-0.1;          %constraint: y2-y1<0.1
